...
//        edited by exd
        String[] InspectionTimestamp = item.getStationsDetalis().getInspectionTimestamp().split(" ");
        holder.setDate(InspectionTimestamp[0]);
        holder.setTime(InspectionTimestamp[1]);
