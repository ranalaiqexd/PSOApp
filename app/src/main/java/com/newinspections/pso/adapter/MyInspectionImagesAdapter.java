...
public class MyInspectionImagesAdapter extends RecyclerView.Adapter<MyInspectionImagesAdapter.ViewHolder> {
    ...
    float dpWidth;
    public MyInspectionImagesAdapter(Context context, List<String> arrayList,String path,OnItemClickListener.OnItemClickCallback onItemClickCallback) {
    ...
    protected class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setImage(String image) {
            ...
            Picasso.with(context)
                    .load(path+image)
                    .into(imgItem1);
            imgItem1.setOnClickListener(new OnItemClickListener(getAdapterPosition(),onItemClickCallback));
        }
    }
}
