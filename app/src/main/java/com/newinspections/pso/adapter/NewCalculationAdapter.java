 ...
 */
public class NewCalculationAdapter extends RecyclerView.Adapter<NewCalculationAdapter.ViewHolder> {
    private List<InspectionDTO.Station.Calculation> arrayList;
    private Context context;
    public NewCalculationAdapter(Context context, List<InspectionDTO.Station.Calculation> arrayList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        InspectionDTO.Station.Calculation item=arrayList.get(position);
