...
public class InspectionDTO {
        ...
        public class Station {
                ...
                @SerializedName("salesGroupArea")
                @Expose
                private String salesGroupArea;
                @SerializedName("divisionArea")
                @Expose
...
//            edited by exd
                public String getSalesGroupArea()
                {
                    return salesGroupArea;
                }

                public void setSalesGroupArea(String salesGroupArea)
                {
                    this.salesGroupArea = salesGroupArea;
                }

                public String getDivisionArea()
                {
                    return divisionArea;
                }

                public void setDivisionArea(String divisionArea)
                {
