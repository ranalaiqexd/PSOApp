...
import com.newinspections.pso.view.SplashActivity;
...
public class TaskForLogout extends AsyncTask<String, Void, String[]> {
    ...
    protected String[] doInBackground(String... params) {
        ...
        return logout(ConstantLib.BASE_URL + ConstantLib.URL_LOGOUT,params[0]);
    }
